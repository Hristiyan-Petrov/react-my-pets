...
import * as petsService from '../../services/petServise';
...
const EditPetDetails = ({
    ...
    const onDesctiptionSaveSubmit = (e) => {
        e.preventDefault();
    ...
    const onDescriptionChangeHandler = (e) => {
        ...
        if (e.target.value.length < 10) {
            setErrorMessage('Descriptoin too short')
        } else {
            setErrorMessage('');
        }
    };
    ...
    return (
        <section className="detailsMyPet">
            ...
            <p className="img"><img src={pet.imageURL}/></p>
                <form onSubmit={onDesctiptionSaveSubmit}>
